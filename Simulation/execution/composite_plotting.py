...
def run_composite_gnuplot_program(diagram: Diagram):
    ...
    execute_and_wait(['gnuplot', str(get_gnuplot_file_path(diagram))], get_autogen_path(diagram))
...
def crop_composite(diagram: Diagram):
    ...
    execute_and_wait(['pdfcrop'] + 2 * [str(result_pdf_path)], get_autogen_path(diagram))
