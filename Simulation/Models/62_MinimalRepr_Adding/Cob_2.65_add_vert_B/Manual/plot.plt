...
p "basins/1.tna" u 1:($4<T1 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ddffdd",\
  ...
  "" u 1:2:("s3") with labels point pt 7 ps 0.7 lc rgb 'forest-green' offset 1.0, -0.5,\
  "" u 1:2:("s3") with labels point pt 7 ps 0.5  lc rgb 'light-green' offset 1.0, -0.5,\
  'cyclic_cobwebB2.tna' w l lw 2 lc rgb 'dark-orange', \
  "" u 1:2:("s4") with labels point pt 7 ps 0.7 lc rgb 'dark-orange'  offset 1.0, -0.5,\
  "" u 1:2:("s4") with labels point pt 7 ps 0.5 lc rgb 'khaki1'       offset 1.0, -0.5
