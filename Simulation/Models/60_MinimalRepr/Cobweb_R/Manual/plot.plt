...
T1=2400
T2=2600
p "basins/1.tna" u 1:($3>T1 && $3<T2 && $5>T1 && $5<T2 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ddddff",\
  "basins/1.tna" u 1:($3>T2 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ffffdd",\
  "basins/1.tna" u 1:($5>T2 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ddffdd",\
  ...
  'cyclic_cobwebA.tna' w lines lw 2 lc rgb 'blue', \
...
p "basins/1.tna" u 1:($3>T1 && $3<T2 && $5>T1 && $5<T2 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ddddff",\
  ...
  'cyclic_cobwebA.tna' w l lw 2 lc rgb 'blue', \
