...
\begin{frame}{Overlapping Period Regions (1/2)}
    \begin{columns}
        ...
        \begin{column}{.2 \textwidth}
            \vspace{-13em}
            \begin{figure}
                \subfloat{ \includegraphics[height=.4 \textheight]{60_MinimalRepr/2D_Regions_Whole/Manual/EF/result.png} }
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{.5 \textwidth}
            ...
            \begin{figure}
                ...
                \\
                \only<1>{
                    \subfloat{\includegraphics[height=.6 \textheight]{60_MinimalRepr/Cobweb_M/Manual/result.png}}
                    \caption*{At point $M$}
                }
                \only<2>{
                    \subfloat{\includegraphics[height=.6 \textheight]{60_MinimalRepr/Cobweb_Q/Manual/result.png}}
                    \caption*{At point $Q$}
                }
                \only<3>{
                    \subfloat{\includegraphics[height=.6 \textheight]{60_MinimalRepr/Cobweb_U/Manual/result.png}}
                    \caption*{At point $U$}
                }
                \only<4>{
                    \subfloat{\includegraphics[height=.6 \textheight]{60_MinimalRepr/Cobweb_X/Manual/result.png}}
                    \caption*{At point $U$}
                }
            \end{figure}
        \end{column}
