	...
	\begin{columns}
		...
		\begin{column}{.5 \textwidth}
			\only<2->{
				...
				\end{figure}
				\begin{itemize}
					\item In between two cycles with periods $a$ and $b$ there is a cycle with period $a + b$
					      \pause
...
\begin{frame}[Rotation Numbers --- A Different Definition]
