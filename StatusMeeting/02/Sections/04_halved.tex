...
\begin{frame}{Period-adding in the Halved Model}
	...
	\end{figure}
	\todo{Replace with larger adding figure and tree}
\end{frame}
...
\begin{frame}{Period-adding in the Halved Model}
	...
	\begin{columns}
		\begin{column}{.7 \textwidth}
			...
			\pause
			\begin{itemize}
				\item Allegory of the cave (``Höhlengleichnis'') type of situation
				\item Needed: A way to translate cycles
				      \begin{itemize}
					      \item Full $\to$ Halved
					      \item Halved $\to$ Full
				      \end{itemize}
...
\begin{frame}{Explained Bifurcation Structures}
	\begin{figure}
		\includegraphics[width=.3 \textwidth]{62_MinimalRepr_Adding/1D_Period_larger_adding/Manual/result.png}
		\includegraphics[width=.15 \textwidth]{../../Report/Figures/FareyTrees/Minrep_Adding1_Lower_Full_Period/adding.pdf}
		\qquad
		\includegraphics[width=.3 \textwidth]{62_MinimalRepr_Adding/1D_Period_larger_adding/Manual/result.png}
		\includegraphics[width=.15 \textwidth]{../../Report/Figures/FareyTrees/Minrep_Adding1_Lower_Full_Period/adding.pdf}
	\end{figure}
	\todo{Replace pics for halved model}
\end{frame}
