...
\begin{frame}{Confirming the Coexistence of Four Cycles}
	\vspace{-1em}
	\begin{figure}
		\subfloat{\includegraphics[width=.4 \textwidth]{../Figures/6/6.11a/result.png}}
		\quad
		\subfloat{\includegraphics[width=.4 \textwidth]{../Figures/6/6.11b/result.png}}
	\end{figure}
\end{frame}
...
\begin{frame}{Confirmation of Archetypal Model}
	\vspace{-1em}
