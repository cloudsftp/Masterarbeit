...
python model.py --start 0 --end 6.28 --resolution 30000 --E0 17 --hi 0.1 --mu 0.5 > model1.dat
python model.py --start 0 --end 6.28 --resolution 30000 --E0 17 --hi 0.2 --mu 0.5 > model2.dat
python model.py --start 0 --end 6.28 --resolution 30000 --E0 17 --hi 0.3 --mu 0.5 > model3.dat
