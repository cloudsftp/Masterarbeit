...
plot    1/0 w line lw 2 lc rgb 'blue' t 'FA12', 'model1.dat' w dots notitle lc rgb 'blue', \
        1/0 w line lw 2 lc rgb 'purple' t 'FB12', 'model2.dat' w dots notitle lc rgb 'purple', \
        1/0 w line lw 2 lc rgb 'red' t 'FC12', 'model3.dat' w dots notitle lc rgb 'red'
