...
p "basins/1.tna" u 1:($3>T1 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ddddff",\
  "basins/1.tna" u 1:($3<T1 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ffdddd",\
...
p "basins/1.tna" u 1:($3>T1 ? 1.0 : 1/0) w filledcurves y2=0 lc rgb "#ddddff",\
  ...
  "" u 1:2:("s1") with labels point pt 7 ps 0.7 lc rgb 'blue' offset -0.5, -1.0,\
  "" u 1:2:("s1") with labels point pt 7 ps 0.5  lc rgb 'light-cyan' offset -0.5, -1.0,\
  'cyclic_cobwebA2.tna' w l lw 2 lc rgb 'red', \
  "" u 1:2:("s2") with labels point pt 7 ps 0.7 lc rgb 'red'  offset 1.0, -0.1,\
  "" u 1:2:("s2") with labels point pt 7 ps 0.5 lc rgb 'pink'       offset 1.0, -0.1
