...
\begin{tikzpicture}
	[transform shape,scale=\Scale,
		...
		level 1/.style={settextwidth=$\A^4\B^3\C^4\D^3\A^4\B^2\C^4\D^3\A^4\B^3\C^4\D^3\A^4\B^3\C^4\D^2\A^4\B^3\C^4\D^3$, level distance=10em},    %,level distance=1cm
	...
	{\tiny$\A^4\B^2\C^4\D^3$\\[-.8em]$\A^4\B^3\C^4\D^2$}
	node[name=s] at (0,-\TreeDiameter-\NodeHeight) {\tiny$\A^4\B^2\C^4\D^2$};

	\path[settextwidth=$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^2\C^4\D^3$] node[name=sr] at (1.5 \LevelDistance,-.5\TreeDiameter)
	{\tiny$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^2\C^4\D^3$}
	child{ node{\tiny$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^2\C^4\D^3\A^4\B^2\C^4\D^3$}
	...
	%---------%
	child{ node[fill=yellow]{\tiny$\A^4\B^2\C^4\D^2\A^4\B^2\C^4\D^3$\\[-.8em]$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2$}
