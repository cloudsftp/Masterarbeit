...
\begin{tikzpicture}
	[transform shape,scale=\Scale,
		...
		level 1/.style={settextwidth=$\A^4\B^3\C^4\D^3\A^4\B^2\C^4\D^3\A^4\B^3\C^4\D^3\A^4\B^3\C^4\D^2\A^4\B^3\C^4\D^3\:\:(64)$, level distance=11em},    %,level distance=1cm
	...
	\path[widthlevel=-1,setwidth=5.1em] node[name=r,fill=yellow] at (0,.5\NodeHeight)
	{\tiny$\A^4\B^2\C^4\D^3\:\:(13)$\\[-.8em]$\A^4\B^3\C^4\D^2\:\:(13)$}
	node[name=s] at (0,-\TreeDiameter-\NodeHeight) {\tiny$\A^4\B^2\C^4\D^2\:\:(12)$};

	\path[settextwidth=$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^2\C^4\D^3\:\:(38)$] node[name=sr] at (1.5 \LevelDistance,-.5\TreeDiameter)
	{\tiny$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^2\C^4\D^3\:\:(38)$}
	child{ node{\tiny$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^3\C^4\D^2\A^4\B^2\C^4\D^3\A^4\B^2\C^4\D^3\:\:(64)$}
			%child{ node[fill=yellow]{\tiny$\A^4\B^3\C^4\D^2\A^4\B^2\C^4\D^2$\\[-.8em]$\A^4\B^2\C^4\D^2\A^4\B^2\C^4\D^3$} }
			%child{ node{\tiny$(\A^4\B^3\C^4\D^2)^2(\A^4\B^2\C^4\D^3)^2\A^4\B^2\C^4\D^2$} }
		}
	%---------%
	child{ node[fill=yellow]{\tiny$\A^4\B^2\C^4\D^2\A^4\B^2\C^4\D^3\:\:(25)$\\[-.8em]$\A^4\B^2\C^4\D^2\A^4\B^3\C^4\D^2\:\:(25)$}
			%child{ node{\tiny$\A^4\B^3\C^4\D^3(\A^4\B^2\C^4\D^3)^2(\A^4\B^3\C^4\D^2)^2$} }
			%child{ node[fill=yellow]{\tiny$\A^4\B^3\C^4\D^3\A^4\B^3\C^4\D^2$\\[-.8em]$\A^4\B^3\C^4\D^3\A^4\B^2\C^4\D^3$} }
		};
	...
	\draw[thick,->] (-1.0,2.5\NodeHeight) -- (10.1,2.5\NodeHeight);
