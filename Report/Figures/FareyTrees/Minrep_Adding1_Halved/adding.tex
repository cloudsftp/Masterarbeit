...
\begin{tikzpicture}
	...
	\path[widthlevel=-1,setwidth=1.8em] node[name=r] at (0,\NodeHeight) {\tiny$\L^5\R^4$}
	node[name=s] at (0,-\TreeDiameter-\NodeHeight) {\tiny$\L^6\R^4$};
	...
	child{ node{\tiny$(\L^6\R^4)^2\L^5\R^4$}
			...
			child{ node{\tiny$(\L^6\R^4)^3\L^5\R^4$}
					child{ node{\tiny$\L^6\R^4((\L^6\R^4)^2\L^5\R^4)^2$} }
