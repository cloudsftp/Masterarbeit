...
\begin{tikzpicture}
	...
	node[name=l] at (0,-\TreeDiameter-\NodeHeight) {\tiny$7$};

	\path[setwidth=0.7em] node[name=lr] at (\LevelDistance,-.5\TreeDiameter) {\tiny$20$}
	child{ node{\tiny$33$}
			child{ node{\tiny$46$} }
			child{ node{\tiny$53$} }
		}
	...
	\draw[thick,->] (-0.5,2.3\NodeHeight) -- (3.2,2.3\NodeHeight);
