...
\begin{figure}
	\centering
	\subfloat[Full]{
		\includegraphics[width=.48 \textwidth]{../Figures/5.5a/result.png}
		\label{fig:setup.quad.even.period.full}
	}
	\subfloat[Zoomed]{
		\includegraphics[width=.48 \textwidth]{../Figures/5.5b/result.png}
...
\begin{figure}
	\centering
	\subfloat[$A$]{
		\includegraphics[width=.3 \textwidth]{../Figures/5.6a/result.png}
		\label{fig:setup.quad.even.cobweb.A}
	}
	\subfloat[$B$]{
		\includegraphics[width=.3 \textwidth]{../Figures/5.6b/result.png}
		\label{fig:setup.quad.even.cobweb.B}
	}
	\subfloat[$C$]{
		\includegraphics[width=.3 \textwidth]{../Figures/5.6c/result.png}
