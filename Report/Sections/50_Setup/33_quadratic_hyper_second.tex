...
\begin{figure}
	\centering
	\subfloat[$A$]{
		\includegraphics[width=.3 \textwidth]{41_Quadratic_fittingR_Gecko/Cobweb_A/result.png}
		\label{fig:setup.quad.hyper.2.cobweb.A}
	}
	\subfloat[$B$]{
		\includegraphics[width=.3 \textwidth]{41_Quadratic_fittingR_Gecko/Cobweb_B/Manual/result.png}
		\label{fig:setup.quad.hyper.2.cobweb.B}
	}
	\subfloat[$C$]{
		\includegraphics[width=.3 \textwidth]{41_Quadratic_fittingR_Gecko/Cobweb_C/result.png}
