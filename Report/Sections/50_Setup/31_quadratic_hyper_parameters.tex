...
Also, the composite parameter $g_R\left(\frac{1}{2}\right) = \frac{1}{2} + \epsilon$ is fixed with $\epsilon = 0.025$ to have the value at the right border of the branches $f_\B$ and $f_\D$ just above the bisector $y = x$.
