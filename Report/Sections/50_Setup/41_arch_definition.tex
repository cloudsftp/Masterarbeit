...
Hence, the equations for $b_R$ and $c_R$ in dependence of the composite parameters $g_R\left(\frac{1}{4}\right)$ and $g_R\left(\frac{1}{4}\right)$ are \Cref{equ:setup.arch.bR,equ:setup.arch.cR}.
