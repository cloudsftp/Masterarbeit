...
\Cref{fig:setup.arch.period} shows the 2D scans of the periods associated with parameter regions in the archetypal model.
...
\begin{figure}
	...
	\caption[Cobweb diagrams at three parameter values in the archetypal model]{
		...
		The parameters $a_L = 4, b_L = -\frac{1}{2},$ and $g_R\left(\frac{1}{2}\right) = \frac{1}{2} + \frac{1}{40}$ are fixed.
		The parameters $\alpha = -g_R\left(\frac{1}{4}\right)$ and $\beta = c_L$ are different in every diagram and their values are marked with point in \Cref{fig:setup.arch.period}.
