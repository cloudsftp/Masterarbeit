...
\begin{figure}
	...
	\subfloat[2D scan of the boundaries]{
		\includegraphics[width=.48 \textwidth]{98_Yunus_modpi/2D_Regions_Coex4/result.png}
		\label{fig:arch.coex.og.regions}
	}
	\subfloat[Cobweb diagram at point $X$]{
		\includegraphics[width=.48 \textwidth]{99_Yunus/Cobweb_Coex4_A/Manual/result.png}
