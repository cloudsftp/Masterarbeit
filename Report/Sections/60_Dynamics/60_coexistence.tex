...
\begin{figure}
	...
	\subfloat[Parameter region $E_{16}$]{
		\includegraphics[width=.4 \textwidth]{../Figures/6/6.10a/result.png}
		\label{fig:arch.coex.regions.E}
	}
	\subfloat[Parameter region $F_{16}$]{
		\includegraphics[width=.4 \textwidth]{../Figures/6/6.10b/result.png}
...
\hl{For this case there is no extra cobweb diagram in this section, since there are already many cobweb diagrams of single ``type A'' cycles in the previous section,} \Cref{sec:arch.dynamics}.
\hl{For example in} \Cref{fig:arch.dyn.cobweb.A,fig:arch.dyn.cobweb.C,fig:arch.dyn.cobweb.E,fig:arch.dyn.cobweb.G,fig:arch.dyn.cobweb.E14,fig:arch.dyn.cobweb.E18}.
...
\begin{enumerate*}
	...
	\item $\Cycle{\A^a\B^{b-1}\C^a\D^{b-1}}$.
\end{enumerate*}
For the \hl{specific} case pictured in \Cref{fig:arch.coex.regions.E}, this results in the following coexistence scenarios.
\begin{enumerate}
	\item $\A^5\B^3\C^5\D^3$ and $\A^4\B^3\C^4\D^3$, marked with $M$ \hl{in} \Cref{fig:arch.coex.regions.E},
	\item $\A^5\B^3\C^5\D^3$ and $\A^5\B^4\C^5\D^4$, marked with $N$ \hl{in} \Cref{fig:arch.coex.regions.E},
	\item $\A^5\B^3\C^5\D^3$ and $\A^6\B^3\C^6\D^3$, marked with $O$ \hl{in} \Cref{fig:arch.coex.regions.E}, and
	\item $\A^5\B^3\C^5\D^3$ and $\A^5\B^2\C^5\D^2$, marked with $P$ \hl{in} \Cref{fig:arch.coex.regions.E}.
\end{enumerate}
\Cref{fig:arch.coex.cobweb.M} shows the cobweb diagram for the point $M$ \hl{in} \Cref{fig:arch.coex.regions.E}.
...
\begin{figure}
	\centering
	\subfloat[$M$]{
		\includegraphics[width=.45 \textwidth]{../Figures/6/6.11a/result.png}
		\label{fig:arch.coex.cobweb.M}
	}
	\subfloat[$Q$]{
		\includegraphics[width=.45 \textwidth]{../Figures/6/6.11b/result.png}
...
In the concrete case marked with the point $Q$ \hl{in} \Cref{fig:arch.coex.regions.F}, these cycles are $\Cycle{\A^5\B^3\C^4\D^4}$ and $\Cycle{\A^4\B^4\C^5\D^3}$.
...
\begin{enumerate}
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3,$ and $\A^4\B^4\C^4\D^4$, marked with $R$ \hl{in} \Cref{fig:arch.coex.regions.F},
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3,$ and $\A^5\B^4\C^5\D^4$, marked with $S$ \hl{in} \Cref{fig:arch.coex.regions.F},
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3,$ and $\A^5\B^3\C^5\D^3$, marked with $T$ \hl{in} \Cref{fig:arch.coex.regions.F}, and
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3,$ and $\A^4\B^3\C^4\D^3$, marked with $U$ \hl{in} \Cref{fig:arch.coex.regions.F}.
\end{enumerate}

\Cref{fig:arch.coex.cobweb.U} shows the cobweb diagram at the point $U$ \hl{in} \Cref{fig:arch.coex.regions.F}.
...
\begin{figure}
	\centering
	\subfloat[$U$]{
		\includegraphics[width=.45 \textwidth]{../Figures/6/6.12a/result.png}
		\label{fig:arch.coex.cobweb.U}
	}
	\subfloat[$X$]{
		\includegraphics[width=.45 \textwidth]{../Figures/6/6.12b/result.png}
...
\begin{enumerate}
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3, \A^4\B^4\C^4\D^4,$ and $\A^5\B^4\C^5\D^4$, marked with $V$ \hl{in} \Cref{fig:arch.coex.regions.F},
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3, \A^5\B^4\C^5\D^4,$ and $\A^5\B^3\C^5\D^3$, marked with $W$ \hl{in} \Cref{fig:arch.coex.regions.F},
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3, \A^5\B^3\C^5\D^3,$ and $\A^4\B^3\C^4\D^3$, marked with $X$ \hl{in} \Cref{fig:arch.coex.regions.F}, and
	\item $\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3, \A^4\B^3\C^4\D^3,$ and $\A^4\B^4\C^4\D^4$, marked with $Y$ \hl{in} \Cref{fig:arch.coex.regions.F}.
\end{enumerate}

\Cref{fig:arch.coex.cobweb.X} shows the cobweb diagram for the point $X$ \hl{in} \Cref{fig:arch.coex.regions.F}.
...
If we compare this cobweb diagram to the cobweb diagram \hl{in} \Cref{fig:arch.coex.cobweb.U} of point $U$ \hl{in} \Cref{fig:arch.coex.regions.F}, we can see that the cycles $\Cycle{\A^4\B^3\C^4\D^3}$ \hl{shown in red}, $\Cycle{\A^5\B^3\C^4\D^4}$ \hl{shown in green}, and $\Cycle{\A^4\B^4\C^5\D^3}$ \hl{shown in brown} exist at almost the same point.
...
\Citeauthor{akyuz2022} \hl{covered all these coexistence scenarios in} \cite{akyuz2022} \hl{with one exception}.
\hl{
...
\hl{For this,} \Cref{fig:arch.coex.og.regions} \hl{shows a 2D scan of the boundaries of parameter regions zoomed in at the lower left corner of the ``type B'' parameter region containing the point $F_{16}$ shown in} \Cref{fig:etup.og.overlapping.regions.zoomed}.
...
The cobweb diagram at point $X$ \hl{shown in} \Cref{fig:arch.coex.og.regions}, \hl{which is in} the region where the two ``type A'' parameter regions and the ``type B'' parameter region should overlap, is shown in \Cref{fig:arch.coex.og.cobweb}.
...
\begin{figure}
	...
	\subfloat[2D scan of the boundaries]{
		\includegraphics[width=.48 \textwidth]{../Figures/6/6.13a/result.png}
		\label{fig:arch.coex.og.regions}
	}
	\subfloat[Cobweb diagram at point $X$]{
		\includegraphics[width=.48 \textwidth]{../Figures/6/6.13b/result.png}
