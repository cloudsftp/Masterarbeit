...
As before in \Cref{fig:setup.quad.hyper.2.period,fig:setup.arch.period}, we scan the normal archetypal model as well as the adjusted archetypal model that allows us to see the ``type B'' parameter regions.
