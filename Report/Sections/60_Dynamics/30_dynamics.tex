...
As in\hl{ }\cite{akyuz2022}\hl{,} \hl{this section examines} the chain of parameter regions \hl{associated with} stable cycles of period $16$.
The parameter regions are marked with the points $A_{16}$ to $G_{16}$ in \Cref{fig:arch.dyn.period}.
\Cref{fig:arch.dyn.cobwebs.1} shows \hl{cobweb diagrams} for the points $A_{16}, B_{16},$ and $C_{16}$.
...
Thus far these parameter regions follow the rules laid out in\hl{ }\cite{akyuz2022}\hl{ }and listed again in \Cref{sec:state.og.dynamics}.
