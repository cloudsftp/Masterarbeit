...
\begin{figure}
	...
	\caption[2D scans of the periods associated with parameter regions in the archetypal model]{
		...
		The points $A_{16}, B_{16}, C_{16}, D_{16}, E_{16},$ and $F_{16}$ mark the parameter values used for the cobweb diagrams in \Cref{fig:arch.dyn.cobwebs}.
...
\begin{figure}
	...
	\subfloat[$D_{16}$]{
		\includegraphics[width=.3 \textwidth]{../Figures/6/6.2d/result.png}
		\label{fig:arch.dyn.cobweb.D}
	}
	\subfloat[$E_{16}$]{
		\includegraphics[width=.3 \textwidth]{../Figures/6/6.2e/result.png}
		\label{fig:arch.dyn.cobweb.E}
	}
	\subfloat[$F_{16}$]{
		\includegraphics[width=.3 \textwidth]{../Figures/6/6.2f/result.png}
		\label{fig:arch.dyn.cobweb.F}
	} \\
	\subfloat[$G_{16}$]{
		\includegraphics[width=.3 \textwidth]{../Figures/6/6.2g/result.png}
		\label{fig:arch.dyn.cobweb.G}
	}
	\subfloat[$E_{14}$]{
		\includegraphics[width=.3 \textwidth]{../Figures/6/6.2i/result.png}
		\label{fig:arch.dyn.cobweb.E14}
	}
	\subfloat[$E_{18}$]{
		\includegraphics[width=.3 \textwidth]{../Figures/6/6.2h/result.png}
		\label{fig:arch.dyn.cobweb.E18}
	}
	\caption[Cobweb diagrams at nine parameter values in the archetypal model]{
		Cobweb diagrams at nine parameter values in the archetypal model.
		The parameters $a_L = 4, b_L = -\frac{1}{2},$ and $g_R\left(\frac{1}{2}\right) = \frac{1}{2} + \frac{1}{40}$ are fixed.
		The parameters $\alpha = -g_R\left(\frac{1}{4}\right)$ and $\beta = c_L$ are different in every diagram and their values are marked with points in \Cref{fig:arch.dyn.period}.
...
\Crefrange{fig:arch.dyn.cobweb.A}{fig:arch.dyn.cobweb.C} shows cobweb diagrams for the points $A_{16}, B_{16},$ and $C_{16}$.
...
This chain continues to abide by the rules as can be seen in the cobweb diagrams of points $D_{16}, E_{16},$ and $F_{16}$ in \Crefrange{fig:arch.dyn.cobweb.D}{fig:arch.dyn.cobweb.F}.
...
\Crefrange{fig:arch.dyn.cobweb.G}{fig:arch.dyn.cobweb.E18} show the cobweb diagrams of the archetypal model at the points $G_{16}, E_{14},$ and $E_{18}$.
