...
The reason for this is that many bifurcations, especially border collision bifurcations, are necessarily global in \gls{pws} discontinuous maps and normal forms only work for local bifurcations~\cite{avrutin2019continuous}.
