...
The reason for this is that many bifurcations, especially \glspl{bcb}, are necessarily global in \gls{pws} discontinuous maps and normal forms only work for local bifurcations.
\todo{Citation, \cite{avrutin2019continuous}}
