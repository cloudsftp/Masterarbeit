...
\hl{Now} a class of bifurcation structures that this thesis covers towards the end in \Cref{chap:add} \hl{is introduced}.
...
\Cref{fig:state.discont.adding.farey.rot} shows such a Farey-tree of a \hl{\gls{pa}} structure between two fixed points, $\L$ and $\R$.
