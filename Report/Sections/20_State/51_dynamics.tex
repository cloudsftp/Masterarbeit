...
The colors in the 2D scan in \Cref{fig:state.og.dynamics.period} indicate the period of the stable cycle in those regions.
...
\begin{figure}
	...
	\subfloat[$C$]{
		\includegraphics[width=.3 \textwidth]{../Figures/2/2.4c/result.png}
	...
	\caption[Cobweb diagrams at three parameter values in the original model]{
		...
		The parameters $\beta = 1, f = 150, L = 4.2 \cdot 10^{-3}, R = 2, V_m = 5,$ and $\mu = 0.5$ are fixed.
		The parameter values of $E_0$ and $\chi_0$ are different in every diagram and are marked with points in \Cref{fig:state.og.dynamics.period}.
