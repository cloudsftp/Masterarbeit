...
\Cref{fig:final.period.whole.full} shows the scan of the full model and \Cref{fig:final.period.whole.halved} for the halved model, indicating the ``type B'' parameter regions.
...
\todo{argue last parameter region must be w/ $\A^2$?}
