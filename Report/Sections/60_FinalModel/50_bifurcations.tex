...
For this purpose, we consider the parameter region $\P_{\A^5\B^3\C^4\D^4, \A^4\B^4\C^5\D^3}$ that contains the point $D_{16}$.
In contrast to the last section covering ``type A'' parameter regions, here there are two coexisting stable cycles.
The boundaries are enumerated as $D_{16}^\uparrow, D_{16}^\rightarrow, D_{16}^\downarrow,$ and $D_{16}^\leftarrow$.

\subsubsection{The Boundary $D_{16}^\uparrow$}

\Cref{fig:final.bifurcation.D.up} shows the bifurcation diagram of the first considered border, $D_{16}^\uparrow$.
...
\Cref{fig:final.bifurcation.D.up.zoomed} shows the black region that is marked in the full bifurcation diagram.
So as before in \Cref{sec:final.bifurcation.typeA.up} there is a border collision bifurcation of a point of the stable cycle on branch $\A$ with the border $d_1$.
...
The bifurcation diagram for the right boundary is depicted in \Cref{fig:final.bifurcation.D.right}.
Here, the blue stable cycle, $\A^5\B^3\C^4\D^4$, is near the border $d_2$.
Zooming into the marked area, generate \Cref{fig:final.bifurcation.D.right.zoomed}.
...
For the lower boundary, the stable cycles are again near the borders $d_1$ and $d_3$, as can be seen in \Cref{fig:final.bifurcation.D.down}.
But this time, the blue cycle, $\A^5\B^3\C^4\D^4$, is not near the border $d_1$ but rather $d_3$.
We also see that in the zoomed-in version of the bifurcation diagram in \Cref{fig:final.bifurcation.D.down.zoomed} since here the red cycle collides with the border $d_1$, meaning its twin collides with the border $d_3$ at the same time.
...
At the left boundary, the cycles are near the borders $d_0$ and $d_2$ as can be seen in \Cref{fig:final.bifurcation.D.left}.
The red cycle, $\A^4\B^4\C^5\D^3$, is near the border $d_2$.
This is enhanced in \Cref{fig:final.bifurcation.D.left.zoomed}.
