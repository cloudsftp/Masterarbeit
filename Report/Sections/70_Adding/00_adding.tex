...
\begin{figure}
    \centering
    \subfloat[Periods]{
        \includegraphics[width=.5 \textwidth]{62_MinimalRepr_Adding/2D_Period_2.675/result.png}
        \label{fig:minrep.just.before.disappearance.reg}
    }
    \subfloat[Cobweb]{
        \includegraphics[width=.5 \textwidth]{62_MinimalRepr_Adding/Cob_2.675_B/Manual/result.png}
