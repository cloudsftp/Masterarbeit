...
\Cref{fig:add.add.like.hor.2D} shows a 2D scan of the horizontally oriented \gls{pal} structures between the parameter regions $P^{14}_4$ and $P^{12}_4$.
...
Looking at the 1D period scan, we can see why the section is called \glsentrylong{pal}.
...
\begin{figure}
	\centering
	\includegraphics[width=.7 \textwidth]{FareyTrees/Minrep_Adding_larger_Full_hor_lower/adding.png}
...
A red arrow marks again the parameter range for the 1D period scan of this \gls{pal} structure in \Cref{fig:add.add.like.vert.1D}.
...
And again, we provide a Frey-tree with the symbolic sequences associated with the parameter regions in this \gls{pal} structure in \Cref{fig:add.add.like.vert.tree}.
...
\begin{figure}
	\centering
	\includegraphics[width=.7 \textwidth]{FareyTrees/Minrep_Adding_larger_Full_vert_left/adding.png}
	\caption[Farey-tree with the symbolic sequences of a horizontal \glsentrylong{pal} structure]{
...
Finally, we will look at the structure in the corner which \Cref{fig:add.add.like.corn.2D} shows a 2D period scan of.
...
It is the \gls{pal} structure between the parameter regions $P^{12}_3$ and $\left[P^{14}_4 \mid P^{12}_4\right]$ marked with a red arrow in \Cref{fig:add.add.like.corn.2D}.
