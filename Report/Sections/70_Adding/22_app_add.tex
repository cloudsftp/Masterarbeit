...
\hl{Again, the coexisting hybrid twin cycles are very close to the borders $d_1$ and $d_3$ for the parameter values marked with the point $B$ in} \Cref{fig:add.change.appa.hor.regions}.
\hl{We can see this in the cobweb diagram in} \Cref{fig:add.change.appa.hor.cob.B}.
...
\hl{And in} \Cref{fig:add.change.regions.4} \hl{they do not overlap, instead there is space in-between these vertically neighboring ``type A'' parameter regions with hybrid parameter regions and \gls{pal} structures}.
