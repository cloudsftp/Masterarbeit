...
The border collision bifurcations at the upper and lower boundaries of the parameter region with hybrid cycles $\left[P^{22}_4 \mid P^{20}_4\right]$ are shown in \Cref{fig:add.change.appa.hor.bif}.
...
We can see that the border collision bifurcations of the hybrid parameter regions follow similar rules as the border collision bifurcations of ``type B'' parameter regions given in \Cref{sec:arch.bif.sum}.
