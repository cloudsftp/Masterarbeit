...
\hl{This section examines} how changing the parameters as described in \Cref{sec:add.parameters} changes the bifurcation structure of the archetypal model.
...
\Cref{sec:add.change.appa} \hl{covers how these parameter regions are created}.
\hl{These parameter regions are connected to the \gls{pal} structures next to them, as we will see later in} \Cref{sec:add.add.halved}.

The four different diagrams in \Cref{fig:add.change.regions} show the evolution at different points during the transition from \hl{the archetypal model to the piecewise-increasing archetypal model}
