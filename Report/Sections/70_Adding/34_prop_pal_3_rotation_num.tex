...
\begin{figure}
	...
	\caption[Farey-tree with rotation tuples of the horizontal \glsentrylong{pal} structure in the archetypal model described in \Cref{sec:add.add.like}]{
		Farey-tree with rotation tuples of \hl{the} horizontal \glsentrylong{pal} structure in the archetypal model \hl{described in} \Cref{sec:add.add.like}.
	}
...
\begin{theorem}[\hl{Monotonicity} of Rotation Tuples in \gls{pal} Structures]
