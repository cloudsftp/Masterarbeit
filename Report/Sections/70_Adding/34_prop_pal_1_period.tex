...
The function is defined in \Cref{sec:add.halved.tanslating}.
...
\begin{figure}
	...
	\caption[Farey-tree showing the symbolic sequences associated with the parameter regions of a horizontally oriented \glsentrylong{pal} structure]{
		Farey-tree showing the symbolic sequences associated with the parameter regions of the horizontally oriented \gls{pal} structure marked with a red arrow in \Cref{fig:add.halved.hor.2D} up to four levels.
