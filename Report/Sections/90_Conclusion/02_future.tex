...
\todo{how does symmetry effect this structure}
\todo{can same algorithms be used to derive the rules here?}
\todo {if yes, we should get period-adding-like for free and period-incrementing-like easily}
