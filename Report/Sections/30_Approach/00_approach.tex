...
As we mentioned in \Cref{sec:state.discont}, it is not possible to find a normal form for this bifurcation structure since the model is discontinuous.
...
\todo{Whats the difference exactly?}
