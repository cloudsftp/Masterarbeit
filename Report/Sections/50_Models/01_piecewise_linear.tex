...
Examples of how the function looks at different parameter values can be seen the cobweb diagrams in \Cref{fig:pcw.lin.CobwebA-C}.
...
\todo{adjust labels for second 1d scan}
...
\todo{cite book about farey adding of cycles}
...
You can see, that the cycles here do not follow Farey-adding like in the other 1D scan.
...
This period-adding structure will also follow the Farey-adding of this cycle and the 3-cycles at point $P_E$, shown in \Cref{fig:pcw.lin.CobwebE}.

\begin{figure}
    \centering
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{01_Linear_Slope_Offset/Cobweb_PointD/result.png}
        \caption{$P_D$}
        \label{fig:pcw.lin.CobwebD}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{01_Linear_Slope_Offset/Cobweb_PointE/result.png}
        \caption{$P_E$}
        \label{fig:pcw.lin.CobwebE}
    \end{subfigure}
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{01_Linear_Slope_Offset/Cobweb_PointF/result.png}
        \caption{$P_F$}
