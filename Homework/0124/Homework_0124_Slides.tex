...
\begin{frame}{(i.b) $a_L = -1, a_R = 0.5$}
    \begin{itemize}
        \item[$\mu >= 0$] Stable fixpoint at $\frac{\mu}{1 - a_R}$, \\
        \item[$\mu < 0$] \begin{itemize}
...
\begin{frame}{(0.a) Fixing $a_L = -2, a_R = 0.75$}
    ...
    \begin{enumerate}
        \item[$\mu >= 0$] stable fixpoint at $\frac{\mu}{1 - a_R}$ w/ absorbing interval $(-\infty, \infty)$
        \item[$\mu < 0$] unstable fixpoint at $\frac{\mu}{2}$
    \end{enumerate}
\end{frame}
